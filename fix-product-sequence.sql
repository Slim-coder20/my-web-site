-- Script SQL pour corriger la séquence d'auto-incrémentation de la table Product
-- 
...
SELECT currval(pg_get_serial_sequence('"Product"', 'id')) AS current_sequence_value;
