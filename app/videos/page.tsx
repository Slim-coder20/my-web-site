  ...
  return (
    <div className={styles.videosContainer}>
      <section className={styles.videosSection}>
        ...
        {/* Butterfly-Asymétrie 2022 */}
        <div className={styles.videosGrid}>
          <div className={styles.videoCard}>
            <div className={styles.videoFrame}>
              <video controls className={styles.video} preload="metadata">
                <source src="/videos/butterfly-video.mp4" type="video/mp4" />
                Votre navigateur ne supporte pas la lecture de vidéos.
              </video>
            </div>
            <div className={styles.videoInfo}>
              <h3 className={styles.videoTitle}>Butterfly-Asymétrie 2022</h3>
              <p className={styles.videoDescription}>Performance live</p>
            </div>
          </div>
          {/* Father-Asymétrie 2022 */}
          <div className={styles.videoCard}>
            <div className={styles.videoFrame}>
              <video controls className={styles.video} preload="metadata">
                <source src="/videos/Father-solo-bass.mp4" type="video/mp4" />
                Votre navigateur ne supporte pas la lecture de vidéos.
              </video>
            </div>
            <div className={styles.videoInfo}>
              <h3 className={styles.videoTitle}>Father-Asymétrie 2022</h3>
              <p className={styles.videoDescription}>
                Performance live - Basse solo
              </p>
            </div>
          </div>
          {/* Live Asymetrie Alexandrie 2025 Egypt Tour  */}
          <div className={styles.videoCard}>
            <div className={styles.videoFrame}>
              <video controls className={styles.video} preload="metadata">
                <source src="/videos/" type="video/mov" />
                Votre navigateur ne supporte pas la lecture de vidéos.
              </video>
            </div>
            <div className={styles.videoInfo}>
              <h3 className={styles.videoTitle}>
                Asymetrtie Alexandrie 2025 Egypt Tour
              </h3>
              <p className={styles.videoDescription}>Performance live</p>
            </div>
          </div>
