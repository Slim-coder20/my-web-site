...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    about: {
      title: "SLIM ABIDA | The Architecture of Groove",
      bio: "Bassist, composer, and sound architect, Slim Abida has established himself over a decade as an essential figure in contemporary Jazz-Fusion in Tunisia. With four albums to his credit (including the highly anticipated Contrast), he deconstructs genres to build electric, edgy, and deeply cinematic music. Here, bass virtuosity serves only one purpose: narrative intensity. Arriving in France in 2011, Slim Abida has continuously explored the resonances between his Mediterranean roots and the effervescence of modern jazz. From the Jazz Oil adventure to his leader projects (Asymétrie, Fréquences Basses), he has refined a unique signature where asymmetric rhythms meet urban textures. His playing, both grounded and ethereal, makes him a bass colorist, capable of transforming a quartet into a true groove machine. With his new opus Contrast, Slim Abida reaches a new stage. More electric, more audacious, the album explores tensions between shadow and light, between organic improvisation and compositional rigor. Accompanied by an exceptional line-up, he offers an immersive live experience that transcends the boundaries of academic jazz to touch the essence of progressive and universal music.",
      discoverMusic: "Discover Music →",
      seeVideos: "See videos →",
      followMe: "Follow me",
    },
