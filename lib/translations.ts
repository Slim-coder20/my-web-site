...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    about: {
      title: "Slim Abida",
      bio: "Slim Abida is a Tunisian bassist and composer, known for his eclectic style, influenced by Richard Bona, Marcus Miller, and Ibrahim Maalouf. In 2002, he co-founded the group Melmoth, a Tunisian metal project that succeeded in making him play internationally (Algeria, Morocco). In 2005, he participated in the Goultrah Sound System project, a fusion of Gnawa, dub, and reggae, which met with great success. He collaborates with internationally renowned artists including Naïssam Jalal, Amine Bouhafa, Emel Mathlouthi, and Sabry Mosbah. In 2016, with Jazz Oil, a jazz-world group of which he is the founder, he released the album Lamma. In 2020, he launched his solo career and released the album Fréquences Basses, followed by Asymétrie in 2022. Currently, he is working on his third solo album, Contrast.",
      discoverMusic: "Discover Music →",
      seeVideos: "See videos →",
      followMe: "Follow me",
    },
